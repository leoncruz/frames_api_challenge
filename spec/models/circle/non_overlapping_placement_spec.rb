...
RSpec.describe Circle::NonOverlappingPlacement do
  describe "#does_not_touch_other_circles" do
    subject(:circle) { Circle.new(center_x: 90.0, center_y: 100.0, diameter: 20.0, frame: frame) }
